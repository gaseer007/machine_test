...
//                         ),
//                         Text(
//                           '₹${(space.pricePerHour * duration).toInt()}',
//                           style: TextStyle(
//                             fontSize: 20.sp,
//                             fontWeight: FontWeight.bold,
//                             color: Color(0xFF2196F3),
...
//                     onPressed:
//                         selectedTimeSlot != null ? _confirmBooking : null,
...
//               content: Text(
//                 'Your booking for ${space.name} has been confirmed for ${DateFormat('MMMM d, y').format(selectedDate)} at $selectedTimeSlot.',
//               ),
//               actions: [
//                 TextButton(
//                   onPressed: () {
